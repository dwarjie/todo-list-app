...
/* harmony import */ var _item_adder_adder_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../item_adder/adder.js */ "./src/modules/item_adder/adder.js");
/* harmony import */ var _inbox_inbox_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../inbox/inbox.js */ "./src/modules/inbox/inbox.js");
	...
	function addToDoItem() {
		...
		if ((0,_validation_validate_todo_js__WEBPACK_IMPORTED_MODULE_4__.Validate_Todo)()) {
			...
			if ((0,_item_adder_title_checker_js__WEBPACK_IMPORTED_MODULE_1__.Title_Checker)(projectTitle.innerHTML)) {
				...
				_data_todo_data_js__WEBPACK_IMPORTED_MODULE_0__.Todo_Data.todoCollections = (0,_item_adder_adder_js__WEBPACK_IMPORTED_MODULE_5__.Adder_Todo)(itemDetails, "Inbox");
				_inbox_inbox_js__WEBPACK_IMPORTED_MODULE_6__.Inbox.render();
			}else {
				_data_todo_data_js__WEBPACK_IMPORTED_MODULE_0__.Todo_Data.todoCollections = (0,_item_adder_adder_js__WEBPACK_IMPORTED_MODULE_5__.Adder_Todo)(itemDetails, projectTitle.innerHTML);
				_personal_personal_js__WEBPACK_IMPORTED_MODULE_7__.Personal.update(); // update the view-todo
			}
...
/* harmony import */ var _populate_update_modal_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./populate_update_modal.js */ "./src/modules/data/populate_update_modal.js");
/* harmony import */ var _renderer_render_update_modal_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../renderer/render_update_modal.js */ "./src/modules/renderer/render_update_modal.js");
/* harmony import */ var _search_inbox_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./search_inbox.js */ "./src/modules/data/search_inbox.js");
/* harmony import */ var _search_project_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./search_project.js */ "./src/modules/data/search_project.js");
...
function Search(id) {
	...
	const inboxKey = (0,_search_inbox_js__WEBPACK_IMPORTED_MODULE_3__.Search_Inbox)(id, searchItem);	
	const { itemKey, projectKey }= (0,_search_project_js__WEBPACK_IMPORTED_MODULE_4__.Search_Project)(id, searchItem);

	if (inboxKey != -1) {
		console.log(_todo_data_js__WEBPACK_IMPORTED_MODULE_0__.Todo_Data.todoCollections.inbox[inboxKey])
		todoItem = _todo_data_js__WEBPACK_IMPORTED_MODULE_0__.Todo_Data.todoCollections.inbox[inboxKey];
	}
	if (itemKey != -1) {
		console.log(_todo_data_js__WEBPACK_IMPORTED_MODULE_0__.Todo_Data.todoCollections.personal[projectKey][itemKey])
		todoItem = _todo_data_js__WEBPACK_IMPORTED_MODULE_0__.Todo_Data.todoCollections.personal[projectKey][itemKey];
	}

	(0,_renderer_render_update_modal_js__WEBPACK_IMPORTED_MODULE_2__.Render_Update_Modal)(); // show the update modal
	(0,_populate_update_modal_js__WEBPACK_IMPORTED_MODULE_1__.Populate_Update_Modal)(todoItem);
};
...
function updateTodo(e) {
	...
	(0,_data_search_js__WEBPACK_IMPORTED_MODULE_1__.Search)(id);
}
