...
const Top_Navigation = (function() {
	...
	function showModal() {
		...
		_show_modal_js__WEBPACK_IMPORTED_MODULE_1__.Modal.show("show-modal");
	}

	function windowsOnClick(event) {
		if ((0,_close_modal_js__WEBPACK_IMPORTED_MODULE_2__.CloseModal)(event, _show_modal_js__WEBPACK_IMPORTED_MODULE_1__.Modal.getModal()) == true)
			_show_modal_js__WEBPACK_IMPORTED_MODULE_1__.Modal.show("show-modal");
	}
})();
