...
function Personal_Container(itemDetails) {
	return `<h3 class="text-hover">${itemDetails}</h3>`;
}
...
const Add_Project = (function() {
	...
	function addPersonalProject() {
		...
		_personal_js__WEBPACK_IMPORTED_MODULE_1__.Personal.render();
	}
