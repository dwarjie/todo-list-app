...
function CloseModal(event, modalElement, modalClass) {
...
const Top_Navigation = (function() {
	...
	function windowsOnClick(event) {
		console.log(_show_modal_js__WEBPACK_IMPORTED_MODULE_2__.Modal.getModal().classList[0])
		if ((0,_close_modal_js__WEBPACK_IMPORTED_MODULE_3__.CloseModal)(event, _show_modal_js__WEBPACK_IMPORTED_MODULE_2__.Modal.getModal(), _show_modal_js__WEBPACK_IMPORTED_MODULE_2__.Modal.getModal().classList[0]) == true)
			_show_modal_js__WEBPACK_IMPORTED_MODULE_2__.Modal.show("show-modal");
	}
})();
...
const View_Details = (function() {
	...
	function windowsOnClick() {
		if ((0,_top_navigation_close_modal_js__WEBPACK_IMPORTED_MODULE_2__.CloseModal)(event, _top_navigation_show_modal_js__WEBPACK_IMPORTED_MODULE_1__.Modal.getModal(), _top_navigation_show_modal_js__WEBPACK_IMPORTED_MODULE_1__.Modal.getModal().classList[0]) == true)
			_top_navigation_show_modal_js__WEBPACK_IMPORTED_MODULE_1__.Modal.show("show-details");
	}
