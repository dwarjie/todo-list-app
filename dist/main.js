...
function Load_Data() {
	...
	if (localStorage.getItem('todoCollection') === null && localStorage.getItem('todoId') === null && localStorage.getItem('personalCollections') === null) {
		...
		_todo_data_js__WEBPACK_IMPORTED_MODULE_0__.Todo_Data.setId = 1;
		_todo_data_js__WEBPACK_IMPORTED_MODULE_0__.Todo_Data.personalProjectCollection = {};
...
function Save_Data() {
	...
	localStorage.setItem(PERSONAL_NAME, _todo_data_js__WEBPACK_IMPORTED_MODULE_0__.Todo_Data.personalProjectCollection);
}
