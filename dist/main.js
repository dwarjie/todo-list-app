...
/* harmony export */ });
/* harmony import */ var _item_adder_title_checker_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../item_adder/title_checker.js */ "./src/modules/item_adder/title_checker.js");
/* harmony import */ var _get_todo_details_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./get_todo_details.js */ "./src/modules/add_todo/get_todo_details.js");
/* harmony import */ var _top_navigation_clear_modal_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../top_navigation/clear_modal.js */ "./src/modules/top_navigation/clear_modal.js");
/* harmony import */ var _validation_validate_todo_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../validation/validate_todo.js */ "./src/modules/validation/validate_todo.js");
/* harmony import */ var _item_adder_adder_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../item_adder/adder.js */ "./src/modules/item_adder/adder.js");
...
const Add_Todo = (function() {
	...
	function addToDoItem() {
		...
		if ((0,_validation_validate_todo_js__WEBPACK_IMPORTED_MODULE_3__.Validate_Todo)()) {
			let itemDetails = (0,_get_todo_details_js__WEBPACK_IMPORTED_MODULE_1__.Get_Details)();
			// check if the user is adding to inbox or personal by checking the project title
			console.log(projectTitle.innerHTML)
			if ((0,_item_adder_title_checker_js__WEBPACK_IMPORTED_MODULE_0__.Title_Checker)(projectTitle.innerHTML)) {
				// user is adding to the inbox
				collections = (0,_item_adder_adder_js__WEBPACK_IMPORTED_MODULE_4__.Adder_Todo)(itemDetails, "Inbox");
				_inbox_inbox_js__WEBPACK_IMPORTED_MODULE_5__.Inbox.render();
			}else {
				collections = (0,_item_adder_adder_js__WEBPACK_IMPORTED_MODULE_4__.Adder_Todo)(itemDetails, projectTitle.innerHTML);
				console.log('Personal Render')
			}
			(0,_top_navigation_clear_modal_js__WEBPACK_IMPORTED_MODULE_2__.Clear_Form)(); // clear the form
		}else {
...
/* harmony import */ var _project_checker_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./project_checker.js */ "./src/modules/item_adder/project_checker.js");
...
function Adder_Todo(itemDetails, projectTitle) {
	...
	if ((0,_title_checker_js__WEBPACK_IMPORTED_MODULE_0__.Title_Checker)(projectTitle)) {
		...
		if((0,_project_checker_js__WEBPACK_IMPORTED_MODULE_1__.Project_Checker)(todoCollections.personal, projectTitle)) {
...
/* harmony import */ var _cancel_adding_project_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./cancel_adding_project.js */ "./src/modules/personal/cancel_adding_project.js");
/* harmony import */ var _add_project_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./add_project.js */ "./src/modules/personal/add_project.js");
/* harmony import */ var _add_todo_add_todo_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../add_todo/add_todo.js */ "./src/modules/add_todo/add_todo.js");
/* harmony import */ var _renderer_render_personal_project_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../renderer/render_personal_project.js */ "./src/modules/renderer/render_personal_project.js");
/* harmony import */ var _clear_input_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./clear_input.js */ "./src/modules/personal/clear_input.js");
/* harmony import */ var _renderer_clear_content_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../renderer/clear_content.js */ "./src/modules/renderer/clear_content.js");
...
const Personal = (function() {
	...
	function renderPersonalProject() {
		(0,_renderer_render_personal_project_js__WEBPACK_IMPORTED_MODULE_5__.Render_Personal_Project)(_add_project_js__WEBPACK_IMPORTED_MODULE_3__.Add_Project.getCollection());
		(0,_renderer_render_project_adder_js__WEBPACK_IMPORTED_MODULE_0__.Render_Project_Adder)();
		(0,_clear_input_js__WEBPACK_IMPORTED_MODULE_6__.Clear_Input)();
	}	

	// this function will handle all the rendering for the view-todo view 
	function render(e) {
		(0,_renderer_clear_content_js__WEBPACK_IMPORTED_MODULE_7__.Clear_Content)(); // clear all the content inside the main view todo
		// get the target innerHTML and use it to change project title
		projectTitle.innerHTML = e.target.innerHTML;
		console.log(_add_todo_add_todo_js__WEBPACK_IMPORTED_MODULE_4__.Add_Todo.getCollection())		
		;(0,_renderer_render_js__WEBPACK_IMPORTED_MODULE_1__.Render_Todo)(_add_todo_add_todo_js__WEBPACK_IMPORTED_MODULE_4__.Add_Todo.getCollection().personal[projectTitle.innerHTML])
	}
...
/* harmony export */ });
/* harmony import */ var _filter_project_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./filter_project.js */ "./src/modules/today/filter_project.js");
...
const Filtered_Today = (function() {
	...
	function getFilteredCollection() {
		...
		// then filter it
		let todoCollection = _add_todo_add_todo_js__WEBPACK_IMPORTED_MODULE_1__.Add_Todo.getCollection().inbox;
		let filteredCollection = todoCollection.filter(dueToday);
		// filter the todo collection in personal project
		(0,_filter_project_js__WEBPACK_IMPORTED_MODULE_0__.Filter_Project)(_add_todo_add_todo_js__WEBPACK_IMPORTED_MODULE_1__.Add_Todo.getCollection().personal, dueToday);
