...
/* harmony import */ var _render_status_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./render_status.js */ "./src/modules/renderer/render_status.js");
...
function Render_Todo(todoCollection) {
	...
	if (todoCollection != undefined) {
		if (Object.keys(todoCollection).length != 0) {
			...
			(0,_render_status_js__WEBPACK_IMPORTED_MODULE_4__.Render_Status)(cbStatusElements);
		}
	}else {
		return undefined;
	}
